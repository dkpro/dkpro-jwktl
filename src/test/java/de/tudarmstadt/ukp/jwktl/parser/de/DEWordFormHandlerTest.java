...
public class DEWordFormHandlerTest extends DEWiktionaryEntryParserTest {
	...
	public void testStaat() throws Exception {
		...
		assertWordFormNoun("die Stäte", NOMINATIVE, PLURAL, null, -1, actualIter.next());
		assertWordFormNoun("die Staat", NOMINATIVE, PLURAL, null, -1, actualIter.next());
		assertWordFormNoun("die Staate", NOMINATIVE, PLURAL, null, -1, actualIter.next());
		...
		assertWordFormNoun("der Stäte", GENITIVE, PLURAL, null, -1, actualIter.next());
		assertWordFormNoun("der Staat", GENITIVE, PLURAL, null, -1, actualIter.next());
		assertWordFormNoun("der Staate", GENITIVE, PLURAL, null, -1, actualIter.next());
		...
		assertWordFormNoun("den Stäten", DATIVE, PLURAL, null, -1, actualIter.next());
		assertWordFormNoun("den Staaten", DATIVE, PLURAL, null, -1, actualIter.next());
		assertWordFormNoun("den Staaten", DATIVE, PLURAL, null, -1, actualIter.next());
		...
		assertWordFormNoun("die Stäte", ACCUSATIVE, PLURAL, null, -1, actualIter.next());
		assertWordFormNoun("die Staat", ACCUSATIVE, PLURAL, null, -1, actualIter.next());
		assertWordFormNoun("die Staate", ACCUSATIVE, PLURAL, null, -1, actualIter.next());
		assertFalse(actualIter.hasNext());
	}
	...
	public void testMockumentary() throws Exception {
		...
		assertWordFormNoun("Mockumentary", NOMINATIVE, SINGULAR, FEMININE, -1, actualIter.next());
		assertWordFormNoun("Mockumentary", NOMINATIVE, SINGULAR, NEUTER, -1, actualIter.next());
		...
		assertWordFormNoun("Mockumentary", GENITIVE, SINGULAR, FEMININE, -1, actualIter.next());
		assertWordFormNoun("Mockumentarys", GENITIVE, SINGULAR, FEMININE, -1, actualIter.next());
		assertWordFormNoun("Mockumentary", GENITIVE, SINGULAR, NEUTER, -1, actualIter.next());
		assertWordFormNoun("Mockumentarys", GENITIVE, SINGULAR, NEUTER, -1, actualIter.next());
		...
		assertWordFormNoun("Mockumentary", DATIVE, SINGULAR, FEMININE, -1, actualIter.next());
		assertWordFormNoun("Mockumentary", DATIVE, SINGULAR, NEUTER, -1, actualIter.next());
		...
		assertWordFormNoun("Mockumentary", ACCUSATIVE, SINGULAR, FEMININE, -1, actualIter.next());
		assertWordFormNoun("Mockumentary", ACCUSATIVE, SINGULAR, NEUTER, -1, actualIter.next());
	...
	public void testKeks() throws Exception {
		...
		assertWordFormNoun("Keks", NOMINATIVE, SINGULAR, NEUTER, -1, actualIter.next());
		...
		assertWordFormNoun("Kekses", GENITIVE, SINGULAR, NEUTER, -1, actualIter.next());
		...
		assertWordFormNoun("Keks", DATIVE, SINGULAR, NEUTER, -1, actualIter.next());
		assertWordFormNoun("Kekse", DATIVE, SINGULAR, NEUTER, -1, actualIter.next());
		...
		assertWordFormNoun("Keks", ACCUSATIVE, SINGULAR, NEUTER, -1, actualIter.next());
	...
	public void testFels() throws Exception {
		...
		assertWordFormNoun("Felsen", GENITIVE, SINGULAR, MASCULINE, -1, actualIter.next());
		...
		assertWordFormNoun("Felsen", DATIVE, SINGULAR, MASCULINE, -1, actualIter.next());
		...
		assertWordFormNoun("Felsen", ACCUSATIVE, SINGULAR, MASCULINE, -1, actualIter.next());
	...
	public void testUnschlitt() throws Exception {
		...
		assertWordFormNoun("Unschlitt", NOMINATIVE, SINGULAR, MASCULINE, -1, actualIter.next());
		...
		assertWordFormNoun("Unschlitts", GENITIVE, SINGULAR, MASCULINE, -1, actualIter.next());
		assertWordFormNoun("Unschlittes", GENITIVE, SINGULAR, MASCULINE, -1, actualIter.next());
		...
		assertWordFormNoun("Unschlitt", DATIVE, SINGULAR, MASCULINE, -1, actualIter.next());
		...
		assertWordFormNoun("Unschlitt", ACCUSATIVE, SINGULAR, MASCULINE, -1, actualIter.next());
	...
	public void testGeneraladmiral() throws Exception {
		...
		assertWordFormNoun("Generaladmiräle", NOMINATIVE, PLURAL, null, -1, actualIter.next());
		...
		assertWordFormNoun("Generaladmiräle", GENITIVE, PLURAL, null, -1, actualIter.next());
		...
		assertWordFormNoun("Generaladmirälen", DATIVE, PLURAL, null, -1, actualIter.next());
		...
		assertWordFormNoun("Generaladmiräle", ACCUSATIVE, PLURAL, null, -1, actualIter.next());
		assertFalse(actualIter.hasNext());
	}
	...
	public void testGams() throws Exception {
		...
		assertWordFormNoun("Gams", NOMINATIVE, SINGULAR, MASCULINE, -1, actualIter.next());
		assertWordFormNoun("Gams", NOMINATIVE, SINGULAR, NEUTER, -1, actualIter.next());
		assertWordFormNoun("Gams", GENITIVE, SINGULAR, NEUTER, -1, actualIter.next());
		assertWordFormNoun("Gams", GENITIVE, SINGULAR, MASCULINE, -1, actualIter.next());
		assertWordFormNoun("Gamsen", GENITIVE, SINGULAR, MASCULINE, -1, actualIter.next());
		assertWordFormNoun("Gamsen", DATIVE, SINGULAR, MASCULINE, -1, actualIter.next());
		assertWordFormNoun("Gamsen", ACCUSATIVE, SINGULAR, MASCULINE, -1, actualIter.next());
		assertWordFormNoun("Gamsen", GENITIVE, SINGULAR, NEUTER, -1, actualIter.next());
		assertWordFormNoun("Gamsen", DATIVE, SINGULAR, NEUTER, -1, actualIter.next());
		assertWordFormNoun("Gamsen", ACCUSATIVE, SINGULAR, NEUTER, -1, actualIter.next());
		assertWordFormNoun("Gams", DATIVE, SINGULAR, NEUTER, -1, actualIter.next());
		assertWordFormNoun("Gams", DATIVE, SINGULAR, MASCULINE, -1, actualIter.next());
		assertWordFormNoun("Gams", ACCUSATIVE, SINGULAR, NEUTER, -1, actualIter.next());
		assertWordFormNoun("Gams", ACCUSATIVE, SINGULAR, MASCULINE, -1, actualIter.next());
