...
public class GenusHandler extends PatternBasedIndexedParameterHandler {

	private static final Logger logger = Logger.getLogger(GenusHandler.class.getName());
	...
	public GenusHandler(DEWordFormNounTableHandler nounTableHandler) {
